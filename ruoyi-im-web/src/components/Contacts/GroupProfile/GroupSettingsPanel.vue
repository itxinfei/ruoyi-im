  ...
  <div class="tab-content">
    ...
    <div class="settings-section">
      ...
      <div class="settings-list">
        <div class="setting-item">
          ...
          <el-button v-if="isOwnerOrAdmin" link type="primary" @click="$emit('edit-name')">
        ...
        <div class="setting-item">
          ...
          <el-button v-if="isOwnerOrAdmin" link type="primary" @click="$emit('edit-desc')">
            <el-icon><Edit /></el-icon>修改
          </el-button>
        </div>
      </div>
    ...
    <div v-if="isOwnerOrAdmin" class="settings-section">
      ...
      <div class="settings-list">
        <div class="setting-item">
          ...
          <el-switch :model-value="settings.needVerify" @change="$emit('setting-change', 'needVerify', $event)" />
        </div>
        <div class="setting-item">
          <div class="setting-info">
          ...
          <el-switch :model-value="settings.allowInvite" @change="$emit('setting-change', 'allowInvite', $event)" />
        </div>
        <div class="setting-item">
          <div class="setting-info">
          ...
          <el-switch :model-value="settings.allMuted" @change="$emit('setting-change', 'allMuted', $event)" />
        </div>
      </div>
    </div>
    ...
    <div class="settings-section">
      ...
      <div class="settings-list">
        <div class="setting-item">
          ...
          <el-switch :model-value="isMuted" @change="$emit('mute-change', $event)" />
        </div>
        <div class="setting-item">
          <div class="setting-info">
          ...
          <el-switch :model-value="isTop" @change="$emit('top-change', $event)" />
        </div>
      </div>
    </div>
    ...
    <div class="settings-section danger-section">
      ...
      <div class="action-list">
        <div v-if="isOwner" class="action-item" @click="$emit('transfer')">
        ...
        <div v-if="isOwner" class="action-item danger" @click="$emit('dismiss')">
          <div class="action-icon">
        ...
        <div v-else class="action-item danger" @click="$emit('exit')">
          <div class="action-icon">
