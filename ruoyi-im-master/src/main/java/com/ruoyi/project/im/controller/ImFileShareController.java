...
import com.ruoyi.project.im.domain.ImFileShare;
import com.ruoyi.project.im.service.ImFileShareService;
...
public class ImFileShareController extends BaseController {
    ...
    public AjaxResult remove(@PathVariable String ids) {
        return toAjax(imFileShareService.deleteImFileShareByIds(Convert.toLongArray(ids)));
    }
