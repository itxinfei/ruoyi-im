...
| 文件 | 功能 |
|------|------|
| `src/views/im/document/DocumentList.vue` | 对接真实API（loadDocuments、createDocument、deleteDocument、restoreDocument、starDocument） |

### ✅ P0 - 前端邮箱模块开发 (v1.7)
| 文件 | 功能 |
|------|------|
| `src/composables/useVideoCall.js` | 视频通话管理器 composable |
...
| `src/views/im/email/components/ContextMenu.vue` | 右键菜单组件 |
